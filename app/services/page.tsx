...
export const metadata: Metadata = {
  title: { absolute: "All Roofing Services Liverpool — Repairs, Cleaning, Guttering & More | Sefton Roofing" },
  description:
    "Liverpool's complete roofing and property maintenance service. Roof repairs, emergency roofing, flat roofs, roof cleaning, gutter cleaning, gutter repairs, fascias & soffits, leadwork. Free quotes, 10-year guarantee.",
