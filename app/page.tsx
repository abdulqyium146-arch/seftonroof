...
export const metadata: Metadata = {
  title: { absolute: "Roofers Liverpool — Sefton Roofing & Property Maintenance | 4.9★ 127+ Reviews" },
  description:
    "Liverpool's highest-rated roofing contractor. Expert roof repairs, emergency roofing (60-min response), roof cleaning, gutter cleaning, flat roofs, fascias & soffits. Free quotes · 10-year guarantee · Fully insured.",
  openGraph: {
    title: "Roofers Liverpool — Sefton Roofing & Property Maintenance",
    description:
      "Liverpool's highest-rated roofer. 4.9★ from 127+ reviews. Roof repairs, emergency roofing, roof cleaning, gutter cleaning, flat roofs, fascias & soffits across all of Merseyside. Free quotes, 24/7 emergency.",
    url: SITE.url,
