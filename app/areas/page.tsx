...
export const metadata: Metadata = {
  title: { absolute: "Roofers Liverpool & Merseyside — All Areas Covered | Sefton Roofing" },
  description:
    "Sefton Roofing covers all of Liverpool and Merseyside — Waterloo, Crosby, Bootle, Formby, Southport, Walton, Maghull, Ormskirk and more. 60-min emergency response. Free inspections.",
