...
export const services: Service[] = [
  ...
  },
  {
    ...
    icon: "Factory",
    tagline: "Professional commercial roof cleaning across Liverpool and Merseyside",
    description:
      "Commercial roof cleaning specialists in Liverpool. We clean flat roofs, industrial rooflines, and commercial properties safely and efficiently with minimal disruption.",
    longDescription:
      "Commercial properties in Liverpool — from retail units and office blocks to warehouses, schools, and industrial premises — face the same biological growth challenges as residential roofs, often on a much larger scale. Moss and algae on commercial flat roofs can block drainage points, leading to standing water and structural loading. Blocked gutters on commercial buildings can cause significant damage to stock, equipment, and building fabric. Our commercial cleaning team have experience working on large-scale roofing projects, work within health and safety frameworks, and can operate outside business hours to minimise disruption to your operations.",
    features: [
      "Large-scale flat roof cleaning",
      "Industrial roofline cleaning",
      "COSHH-compliant cleaning methods",
    ...
    benefits: [
      ...
      "Multi-site management available",
      "Detailed post-clean reporting",
      "Priority emergency response for contract clients",
    ],
    process: [
      { step: 1, title: "Site Survey", description: "We assess the site, access requirements, drainage layout, and produce a method statement." },
      { step: 2, title: "Scheduling", description: "We agree a schedule that minimises disruption to your business or tenants." },
      { step: 3, title: "Professional Clean", description: "Our commercial team carries out the full cleaning programme safely and efficiently." },
      { step: 4, title: "Documentation", description: "A full completion report and photographs are provided for your records." },
    ],
    faqs: [
      {
        question: "Do you clean commercial roofs in Liverpool?",
        answer: "Yes. We regularly work on commercial properties across Liverpool and Merseyside including office buildings, retail units, warehouses, schools, and industrial premises. We can provide risk assessments, method statements, and COSHH documentation.",
      },
    ],
    keywords: [
