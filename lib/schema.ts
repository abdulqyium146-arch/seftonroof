...
export function generateLocalBusinessSchema() {
  return {
    ...
    areaServed: [
      ...
      { "@type": "AdministrativeArea", name: "Merseyside", sameAs: "https://en.wikipedia.org/wiki/Merseyside" },
      { "@type": "Place", name: "Waterloo", geo: { "@type": "GeoCoordinates", latitude: 53.4786, longitude: -3.0258 } },
      { "@type": "Place", name: "Crosby", geo: { "@type": "GeoCoordinates", latitude: 53.4869, longitude: -3.0330 } },
      { "@type": "Place", name: "Bootle", geo: { "@type": "GeoCoordinates", latitude: 53.4440, longitude: -2.9927 } },
      { "@type": "Place", name: "Sefton" },
      { "@type": "Place", name: "Formby", geo: { "@type": "GeoCoordinates", latitude: 53.5589, longitude: -3.0685 } },
      { "@type": "Place", name: "Southport", geo: { "@type": "GeoCoordinates", latitude: 53.6452, longitude: -3.0078 } },
      { "@type": "Place", name: "Walton" },
      { "@type": "Place", name: "Everton" },
      { "@type": "Place", name: "Anfield" },
      { "@type": "Place", name: "Aintree" },
      { "@type": "Place", name: "Maghull" },
      { "@type": "Place", name: "Lydiate" },
      ...
      { "@type": "Place", name: "Woolton" },
      { "@type": "Place", name: "Kirkby" },
      { "@type": "Place", name: "Wavertree" },
    ],
    contactPoint: {
      "@type": "ContactPoint",
      telephone: SITE.phone,
    ...
    hasOfferCatalog: {
      "@type": "OfferCatalog",
      name: "Roofing & Property Maintenance Services — Liverpool & Merseyside",
      itemListElement: [
        { "@type": "Offer", itemOffered: { "@type": "Service", name: "Roof Repairs Liverpool", url: `${SITE.url}/services/roof-repairs` } },
        { "@type": "Offer", itemOffered: { "@type": "Service", name: "Emergency Roof Repairs Liverpool", url: `${SITE.url}/services/emergency-roof-repairs` } },
        { "@type": "Offer", itemOffered: { "@type": "Service", name: "Flat Roof Repairs Liverpool", url: `${SITE.url}/services/flat-roof-repairs` } },
        { "@type": "Offer", itemOffered: { "@type": "Service", name: "Roof Cleaning Liverpool", url: `${SITE.url}/services/roof-cleaning` } },
        { "@type": "Offer", itemOffered: { "@type": "Service", name: "Roof Moss Removal Liverpool", url: `${SITE.url}/services/roof-moss-removal` } },
        { "@type": "Offer", itemOffered: { "@type": "Service", name: "Gutter Cleaning Liverpool", url: `${SITE.url}/services/gutter-cleaning` } },
        { "@type": "Offer", itemOffered: { "@type": "Service", name: "Gutter Repairs Liverpool", url: `${SITE.url}/services/gutter-repairs` } },
        { "@type": "Offer", itemOffered: { "@type": "Service", name: "Fascias and Soffits Liverpool", url: `${SITE.url}/services/fascias-and-soffits` } },
        { "@type": "Offer", itemOffered: { "@type": "Service", name: "Leadwork Liverpool", url: `${SITE.url}/services/leadwork` } },
        { "@type": "Offer", itemOffered: { "@type": "Service", name: "Commercial Roof Cleaning Liverpool", url: `${SITE.url}/services/commercial-roof-cleaning` } },
        { "@type": "Offer", itemOffered: { "@type": "Service", name: "Brickwork and Repointing Liverpool", url: `${SITE.url}/services/brickwork` } },
        { "@type": "Offer", itemOffered: { "@type": "Service", name: "Exterior Painting Liverpool", url: `${SITE.url}/services/exterior-painting` } },
        { "@type": "Offer", itemOffered: { "@type": "Service", name: "Property Maintenance Liverpool", url: `${SITE.url}/services/property-maintenance` } },
      ],
    },
  };
}
